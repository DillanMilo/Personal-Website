      ...
      <div className="projects">
        ...
        <div className="project-box">
          <a
            ...
            rel="noopener noreferrer"
          >
            <div className="game-hub">Reddit Mini App</div>
          </a>
          <p className="project-desc">
            A simple Reddit feed viewer that allows users to explore posts and
            comments from various subreddits in a sleek interface.
          </p>
        </div>
      </div>
    </div>
